...
static unsigned int gpioLED = 113;      ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
static unsigned int gpioButton = 50;    ///< hard coding the button gpio for this example to P9_27 (GPIO115)
...
// gpio_set_value(gpioLED, ledOn);          // Not required as set by line above (here for reference)
   ...
   result = request_irq(irqNumber,             // The interrupt number requested
                        ...
                        IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,   // Interrupt on both edges (button press and release)
